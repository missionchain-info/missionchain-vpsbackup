...
// Token Supply (18-dec)
// ─────────────────────────────────────────────────────────────────────────────
export const TOTAL_SUPPLY = 7000000000n * 10n ** 18n; // 7B MIC hard cap
export const PRE_ISSUED = 1050000000n * 10n ** 18n; // 15% pre-minted
export const MINING_POOL = 5950000000n * 10n ** 18n; // 85% progressive emission
// ─────────────────────────────────────────────────────────────────────────────
// Decimals
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
export const ALLOC_SEED_ROUND = 227500000n * 10n ** 18n; // 3.25% (75M Strategic Partner Grant + 152.5M Public Sale)
export const ALLOC_SEED_PUBLIC = 152500000n * 10n ** 18n; // Public Sale only (SeedSale.sol ALLOCATION); $381,250 cap @ $0.0025
export const ALLOC_SEED_GRANT = 75000000n * 10n ** 18n; // Strategic Partner Grant — admin-issued, NOT for sale
export const ALLOC_PRESALE = 315000000n * 10n ** 18n; // 4.50%
export const ALLOC_DEX_LISTING = 105000000n * 10n ** 18n; // 1.50%
export const ALLOC_FOUNDERS = 280000000n * 10n ** 18n; // 4.00%
export const ALLOC_COMMUNITY = 105000000n * 10n ** 18n; // 1.50%
export const ALLOC_AIRDROPS = 17500000n * 10n ** 18n; // 0.25%
...
export const E0_DAILY = 22907500n * 10n ** 18n;
/** Half-life: 180 days */
...
export const NFT_STAKING_CAP = {
    BUILDER: 10000n * 10n ** 18n, // (DEPRECATED — no longer enforced in MICStaking)
    MAKER: 25000n * 10n ** 18n, // (DEPRECATED — no longer enforced in MICStaking)
    LUMINARY: 50000n * 10n ** 18n, // (DEPRECATED — no longer enforced in MICStaking)
    MFP: 100000n * 10n ** 18n, // (DEPRECATED — no longer enforced in MICStaking)
};
...
export const TOKENOMICS = {
    ...
    PRE_ISSUED: 1050000000,
    MINING_POOL: 5950000000,
    SEED_PRICE: 0.0025,
    PRESALE_PRICE: 0.005,
    LISTING_PRICE: 0.01,
    MICE_MAX_SUPPLY: 100000,
