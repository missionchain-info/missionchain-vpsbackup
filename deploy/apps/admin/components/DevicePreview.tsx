    ...
    <>
      <div
        ...
        style={{
          ...
          background: 'rgba(14,33,72,.86)', border: '1px solid rgba(212,166,60,.28)',
          ...
          return (
            <button
              ...
              style={{
                ...
                fontSize: 9, fontWeight: 500, lineHeight: 1, letterSpacing: '.01em',
                border: 'none',
            ...
            >
              <span style={{ fontSize: 10, opacity: on ? 1 : 0.75 }}>{m.icon}</span>
              <span>{m.label}</span>
            </button>
          )
        })}
        {mode !== 'laptop' && (
          <span style={{ fontSize: 8, color: 'rgba(255,255,255,.38)', padding: '0 7px 0 3px' }}>
            {active.w}px
          </span>
        )}
      </div>
