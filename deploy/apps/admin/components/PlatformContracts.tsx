...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: 'SWAP Pool (V7) — live AMM', key: 'LiquidityPoolV7', note: 'The public SWAP pool · RevenueRouter sends the 40% slice straight here · linear price, one-for-one virtual→real, buy-only until $25,000 of real USDT, sell fee 15%→0% on backing' },
      { label: 'SWAP Pool (V6) — NOT PUBLIC', key: 'LiquidityPoolV6', note: 'Superseded 2026-08-17: charges every buyer 2.006× its own quoted spot price. Not upgradeable, no setter reaches the fault. Held back, admin only. Its 49,999,900 MIC can never be withdrawn or burned', warn: true },
      { label: 'LiquidityPool (unused)', key: 'LiquidityPool', note: 'Never in the revenue path — RevenueRouter has always paid the AMM pool directly. Holds $2, no MIC', warn: true },
    ],
  },
  {
    title: 'Rewards',
