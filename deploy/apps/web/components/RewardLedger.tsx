      ...
      <div className="nft-ledger-actions">
          ...
          .map((p) => (
            <button
              ...
              style={{
                ...
                background: p.amount > 0 ? 'var(--gold, #F0B54A)' : 'rgba(255,255,255,.07)',
                color: p.amount > 0 ? '#141018' : 'var(--gray2, #8b8b9a)',
              }}
            >
        ...
        <button
          ...
          style={{
            ...
            background: micUnclaimed > 0 ? 'var(--gold, #F0B54A)' : 'rgba(255,255,255,.07)',
            color: micUnclaimed > 0 ? '#141018' : 'var(--gray2, #8b8b9a)',
          }}
        >
