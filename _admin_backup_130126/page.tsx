  ...
  return (
    <>
      ...
      <PoolSection
        ...
        pct="10%"
        note="Steward Council orders + 3-of-5 approval — coming in Phase 2c"
      >
        <div style={{ padding: 16, color: 'var(--gray2)', fontSize: SZ }}>
          Pool will receive 10% of SEED revenue. Council members create bonus orders; the approval threshold is configurable on-chain and set to 60% — three of five seats, matching DAOGovernor. Owner can cancel.
        </div>
      </PoolSection>
      ...
      <PoolSection
        title="Reserved"
        pct="50%"
        note="DAO-decided expenses — Steward Council 3-of-5 vote (Phase 1) → DAOGovernor (Phase β)"
      >
        <div style={{ padding: 16, color: 'var(--gray2)', fontSize: SZ }}>
